...
/* Property Interfaces */
export interface IDeckProps extends ICardProps {
...
declare class Deck extends Component<IDeckProps> {}

declare class Card extends Component<ICardProps, ICardState> {}

declare module 'react-ts-card' {}
